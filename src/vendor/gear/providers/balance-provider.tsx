...
type AvailableBalance =
  | undefined
  | { value: string; unit: string; existentialDeposit: string };
...
export function BalanceProvider({ children }: PropsWithChildren) {
  const [isAvailableBalanceReady, setIsAvailableBalanceReady] =
    useState<boolean>(false);
  const [availableBalance, setAvailableBalance] =
    useState<AvailableBalance>(undefined);
